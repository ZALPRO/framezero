...
await pg.goto('http://127.0.0.1:4173/probe-perf.html',{waitUntil:'load'});
let done=true;
try{ await pg.waitForFunction(()=>document.title.startsWith('PERF-'),null,{timeout:240000}); }catch(e){ done=false; }
